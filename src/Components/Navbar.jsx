    ...
    <Box className={Styles.sticky}>
      <Box className={Styles.MainBox}>
        ...
        >
          ...
          <a href="./Anmol-fw18_0435-Resume.pdf" download target="_blank">
            <Box
              onClick={() =>
                window.open(
            ...
            >
              Resume <ExternalLinkIcon ml="3px" />
            </Box>
          </a>
          {/* </NavLink> */}
        </Box>
        <Box
          marginRight={{ sm: "20px", md: "20px", base: "20px" }}
          display={{ lg: "none", sm: "flex", md: "flex", base: "flex" }}
          justifyContent={{ sm: "center", md: "center", base: "center" }}
          alignItems={{ sm: "center", md: "center", base: "center" }}
        >
          <Menu>
            <MenuButton
              as={IconButton}
